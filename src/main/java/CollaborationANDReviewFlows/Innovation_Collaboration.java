...
public class Innovation_Collaboration extends TestBase {
	...
	public void send_request() throws InterruptedException {
		...
		first_iteam.click();
		Thread.sleep(3500);
		Testutils.scrollUsingAction(request_button);
		request_button.click();Thread.sleep(1000);
		remark.sendKeys(Random_Name);Thread.sleep(1000);
		submit_button.click();
	...
	public void reject_request() throws InterruptedException {
		...
		reject_button.click();
		Thread.sleep(1000);
		cancel_button.click();Thread.sleep(800);
		checkbox.click();
		Thread.sleep(1000);
		reject_button.click();
		Thread.sleep(1000);
		remark2.sendKeys(Random_Name);Thread.sleep(1000);
	...
	@FindBy(xpath = "(//span[@class='ant-btn-icon'])[last()]")
	WebElement approve_icon;

	@FindBy(xpath = "(//div[@id='_rht_toaster'])[1]")
	WebElement success_message2;
	
	@FindBy(xpath = "(//*[@class=\"tabler-icon tabler-icon-user \"])[1]")
	WebElement collaboration_request2;
	...
	public void accept_request() throws InterruptedException {
		...
		//Thread.sleep(1000);
		//Assert.assertEquals(success_message2.getText(), "Success! Request Response has been submitted.");
		Thread.sleep(1500);
